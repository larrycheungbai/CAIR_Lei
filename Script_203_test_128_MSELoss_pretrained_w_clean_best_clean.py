...
parser.add_argument('--result_dir', default='../ResultMoco/results_mask_pretrained_w_clean_on_test_best_128_clean/', type=str, help='Directory for results')
...
inp_dir = os.path.join(args.input_dir, 'test', dataset, 'clean_image')
